...
add_filter( 'woocommerce_debug_tools', array( 'woo_prune_orders', 'woocommerce_debug_tools' ) );
add_action( 'plugins_loaded',  array( 'woo_prune_orders', 'plugins_loaded' ) );
...
class woo_prune_orders {
	...
	static function woocommerce_debug_tools( $tools ) {
		$tools['prune_cancelled_orders'] = array(
			'button' => __( 'Trash Cancelled orders', 'woocommerce-prune-orders' ),
			'callback' => array( 'woo_prune_orders', 'run_tool' ),
		...
		$tools['prune_completed_orders'] = array(
		...
		$tools['prune_failed_orders'] = array(
		...
		/*
		$tools['prune_onhold_orders'] = array(
		...
		*/
		$tools['prune_pending_orders'] = array(
		...
		$tools['prune_refunded_orders'] = array(
