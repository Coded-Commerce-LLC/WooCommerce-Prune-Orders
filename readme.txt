...
Adds tools to the WP Admin > WooCommerce > Status > Tools page to move all orders of the selected status into the trash, where they can then be permanently deleted to improve site performance.
